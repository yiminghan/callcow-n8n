    ...
    this.webhookMethods = {
      default: {
        ...
        async create() {
          ...
          const workflowId =
            (_a = workflowIdParam.value) !== null && _a !== void 0
              ? _a
              : workflowIdParam;
          try {
            const response =
            ...
            if (statusCode === 401) {
              throw new Error(
                "Authentication failed. Check your Callcow API key in credentials.",
              );
            }
            if (statusCode === 404) {
              throw new Error(
                "Workflow not found. Make sure the selected workflow exists and belongs to your organization.",
              );
            }
            if (statusCode === 429) {
              throw new Error(
            ...
            throw new Error(
              `Failed to register webhook with Callcow: ${error.message}`,
            );
          }
        },
        async delete() {
